...
| 3 | Visibilidade | Título → "Resumo de Visibilidade nas IAs" | ✏️ Copy | Troca simples de string (i18n) | P | ✅ Feito (10/ago) |
...
| 5 | Visibilidade | "Índice de Visibilidade" em vez de "taxa de visibilidade" | ✏️ Copy | Troca de nomenclatura (i18n). Atenção pra não colidir com "Índice de Citabilidade" | P | ✅ Feito (10/ago) |
| 6 | Visibilidade | Botão "Rodar Tudo" maior e à esquerda (demorou a achar) | 🎨 UX | Reposicionar/destacar o CTA | P | ✅ Feito (10/ago) |
| 7 | Visibilidade | Share of Voice zero apesar de ter respostas — explicar | 🎨 UX | SoV conta **menções da marca**, não respostas; zero real precisa de explicação na tela (tooltip/empty-state) | P | ✅ Feito (10/ago) |
...
| 9 | Citabilidade | Faixas de nota: 0-30 Indesejável · 31-50 Regular · 51-70 Boa · 71-90 Ótima · 91-100 Best in class | 🚀 Feature | Ótima ideia, barata — rótulo de faixa junto da nota | P | ✅ Feito (10/ago) — faixas na página Citabilidade |
...
| 11 | Citabilidade | O que significa "35% do índice medido"? | 🎨 UX | O conceito de cobertura confundiu — reescrever o rótulo/explicação | P | ✅ Feito (10/ago) |
...
| 17 | Prompts | Coluna "Work" — o que significa? | ✏️ i18n | Coluna do workflow de prompts sem tradução/clareza | P | ✅ Feito (10/ago) |
| 18 | Prompts | "Visibility" é ranking ou o quê? Melhorar títulos de colunas | 🎨 UX | Tooltips/títulos autoexplicativos nas colunas de resultado | P | ✅ Feito (10/ago) |

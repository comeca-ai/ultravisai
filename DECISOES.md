...
| 11/ago | Alertas do watchdog **por e-mail** (SMTP; Gmail com App Password) como canal principal — webhook Slack/n8n fica opcional pro futuro | Dono sem Slack/n8n operacional; "por enquanto e-mail, ainda tem pouco cliente" | `server/src/lib/watchdog.js` (envs `ALERT_EMAIL_TO`, `SMTP_*`) |

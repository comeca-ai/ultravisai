...
1. **19/ago — o dia da reunião Igor×Jhonata virou produto (11 PRs, #82–#92):**
   ...
   (f) **Ata de decisões Jhonata×Igor** versionada (`estrategia/ata-decisoes-jhonata-igor.md`, 4 sessões, ~30 decisões com evidência) + **12 arquivos dos sócios** em `estrategia/recebidos/` + **wireframe dos processos** (`docs/processos-wireframe.html` + artifact).
